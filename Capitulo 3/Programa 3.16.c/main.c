...
/* Calificaciones.
El programa, al recibir un grupo de calificaciones de un alumno, obtiene el promedio de calificaciones de cada uno de ellos y, ademas, los alumnos con el mejor
y peor promedio.
...
void main(void)
{
   ...
   while (MAT)
   {
       ...
       printf("\n\nIngrese la matrícula del siguiente alumno: "); scanf("%d", &MAT);
   }
