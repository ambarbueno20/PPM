...
tanto para lectura como para escritura. Se utiliza además una funciosn que
...
a la función Lectura. Observa que en este caso debemos utilizar el operador de direccion para preceder a la variable. */
printf("\nDatos del alumno 3\n");
